    ...
    <div class="conteneur-enfant">
        <div class="conteneur-med-2" style="height: 1800px">
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <br>
                <input type="submit" name="action" value="Update Stock Logistique" class="btn btn-primary"/>
            </form>
            <hr />
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <br>
                <input type="submit" name="action" value="Utilisation Materiel Logistique" class="btn btn-primary"/>
            </form>
            <hr />
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <input type="text" name="Materiel_nom" required/>
                <br>
                <input type="submit" name="action" value="Supprimer Materiel Logistique" class="btn btn-danger"/>
            </form>
            <hr />
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <input type="text" name="Materiel_quantite" required pattern="\d+(\.\d+)?" title="Veuillez entrer une valeur numérique"/>
                <br>
                <input type="submit" name="action" value="Commander Materiel Logistique" class="btn btn-primary"/>
            </form>
        ...
        <div class="conteneur-med-3" style="height: 1800px">
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <br>
                <input type="submit" name="action" value="Supprimer Commande" class="btn btn-danger"/>
            </form>
            <hr />
            ...
            <form method="get" action="./ControlInventaire">
                ...
                <br>
                <input type="submit" name="action" value="Ajout Materiel" class="btn btn-success"/>
            </form>
            <hr />
