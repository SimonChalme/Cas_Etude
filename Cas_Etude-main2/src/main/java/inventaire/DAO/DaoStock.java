...
public class DaoStock {
    ...
    // Connexion à la base de données, vérification du succès de la connexion et et de la création des tables si elles n'existent pas
    public DaoStock() {
        try {
    ...
    // Récupération de la liste des commandes dans la base de données
    ...
    // Récupération de la liste des matériels médicales dans la base de données
    ...
    // Récupération de la liste des matériels logistiques dans la base de données
    ...
    // Ajout d'un matériel dans la base de données
    ...
    // Mise à jour de la quantité d'un matériel dans la base de données
    ...
    public void createCommandeMateriel(String nom, String type, int quantite){
        try {
    ...
    // Suppression d'un matériel dans la base de données
    ...
    // Mise à jour de l'utilisation d'un matériel dans la base de données
