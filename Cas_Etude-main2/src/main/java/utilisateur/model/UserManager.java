...
public class UserManager {
    ...
    // on initialise 4 listes qui seront mise à jour avec les valeurs de la base de données voulues via la classe DAO après une action traitée dans la classe contrôle.
